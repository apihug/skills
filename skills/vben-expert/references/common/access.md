---
title: 权限
description: How access control and permissions work.
---
...
<template>
  ...
  <AccessControl :codes="['AC_100100']" type="code">
    <Button> Super 账号可见 ["AC_100100"] </Button>
  </AccessControl>
  <AccessControl :codes="['AC_100030']" type="code">
    <Button> Admin 账号可见 ["AC_100030"] </Button>
  </AccessControl>
  <AccessControl :codes="['AC_1000001']" type="code">
    <Button> User 账号可见 ["AC_1000001"] </Button>
  </AccessControl>
  <AccessControl :codes="['AC_100100', 'AC_100030']" type="code">
    <Button> Super & Admin 账号可见 ["AC_100100","AC_100030"] </Button>
  </AccessControl>
</template>
```
...
<template>
  ...
  <Button v-if="hasAccessByCodes(['AC_100100', 'AC_100030'])">
