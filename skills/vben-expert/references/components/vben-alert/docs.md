---
title: Vben Alert
description: How to use the vben alert component.
---
...
| 名称 | 路径 | 说明 |
|------|------|------|
| Alert 提示框 | [alert](demo/alert/index.vue) | 使用 `alert` 创建只有确认按钮的提示框。 |
| Confirm 确认框 | [confirm](demo/confirm/index.vue) | 使用 `confirm` 创建带确认和取消按钮的提示框。 |
| Prompt 输入框 | [prompt](demo/prompt/index.vue) | 使用 `prompt` 创建可接收用户输入的提示框。 |
